   ...
   <div class='col-sm-6'>
		   ...
		   <div class='img-zoom-container'>
		     <div class='item active'>
			   <center>
			 <img id='myimage' src='image/$p_img1'class='img-responsive'>
	...
	<div class="col-sm-6"><!--col-sm-6-->
	  <div class="box">
	   ...
	   addCart();
	   ?>
	    <form action="gdetails.php?add_cart=<?php echo $pro_id ?>" method="post" class="form-horizontal">
	     <div class="form-group">
		   ...
		   <select name="product_qty" class="form-control">
		    ...
		    <div class="form-group">
		     ...
		     <label class="col-md-5 control-label">Message  in cake</label>
			    <div class="col-md-7">
				 <input type="text" name="product_msg" class="form-control" required>	 
		   </div>
		   </div>
		   ...
		   <h2><p class="price"><?php echo $p_price?></p></h2>
 ...
 while($row=mysqli_fetch_array($run_product)){
   ...
   <div class='product same-height headline'>
     <a href='gdetails.php?pro_id=$pro_id'>
	  ...
	  <div class='text'>
	    <h3><a href='gdetails.php?pro_id=$pro_id'>$product_title</a></h3>
